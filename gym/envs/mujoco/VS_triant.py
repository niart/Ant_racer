...
class TriantEnv(mujoco_env.MujocoEnv, utils.EzPickle):
    ...
    def __init__(self):
        ...
        self.mapping = {"torso_geom": 0, "aux_1_geom":1, "front_left_leg_geom":2,
         ...
         "back_right_ankle_geom3": 38, "tatami": 39, "rightborder": 40,
    ...
    def step(self, action):
        ...
        reward = 5 * x_reward + 5* y_reward #- 2*(self.ant_pos[1:2] - self.spider_pos[1:2])**2 - 2*(self.ant_pos[0:1] - self.spider_pos[0:1])**2 - 4   ## train with velocity for middle agen
